...
#endif
{
    ...
    class MachineManager : IManageMachines
    {
        ...
        public MachineManager(
            ...
            int port = 5985,
            AuthenticationMechanism authentication = AuthenticationMechanism.Default)
        {
        ...
        public AuthenticationMechanism Authentication { get; private set; }
        ...
        public void CopyFileFromSession(string filePathOnTargetMachine, string filePathOnLocalMachine)
        {
            using (var runspace = RunspaceFactory.CreateRunspace())
            {
                ...
                this.CopyFromSession(filePathOnTargetMachine, filePathOnLocalMachine, runspace, sessionObject);
        ...
        private byte[] RetrieveFileUsingSession(string filePathOnTargetMachine, Runspace runspace, object sessionObject, long nibbleStart = 0, long nibbleSize = 0)
        {
            ...
            var bytes = (bytesRaw[0] as PSObject).BaseObject as byte[];
        ...
        private void CopyFromSession(string path, string destination, Runspace runspace, object sessionObject)
        {
            var sessionCommand = new Command("Copy-Item");
            sessionCommand.Parameters.Add("Path", path);
            sessionCommand.Parameters.Add("Destination", destination);
            sessionCommand.Parameters.Add("FromSession", sessionObject);
            RunLocalCommand(runspace, sessionCommand);
        }
        ...
        private object BeginSession(Runspace runspace)
        {
            ...
            sessionCommand.Parameters.Add("Authentication", this.Authentication);
